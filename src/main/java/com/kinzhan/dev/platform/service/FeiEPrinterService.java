...
public class FeiEPrinterService {
    ...
    public static final String USER = "dingxiaosong1987@126.com";//*必填*：账号名
    ...
    public String print(String snId, String appId, String appSecret, String template) {
        ...
        HttpPost post = new HttpPost(URL);
        List<NameValuePair> nvps = new ArrayList<NameValuePair>();
        nvps.add(new BasicNameValuePair("user",appId));
        String STIME = String.valueOf(System.currentTimeMillis()/1000);
        nvps.add(new BasicNameValuePair("stime",STIME));
     ...
     * @return
     */
    public String queryPrinterStatus(String sn, String appId, String appSecret){
        //通过POST请求，发送打印信息到服务器
        RequestConfig requestConfig = RequestConfig.custom()
                .setSocketTimeout(30000)//读取超时
                .setConnectTimeout(30000)//连接超时
