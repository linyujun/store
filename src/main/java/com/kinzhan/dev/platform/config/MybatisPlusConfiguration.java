...
import com.kinzhan.dev.platform.config.handle.MyTenantLineHandler;
import com.kinzhan.dev.platform.config.handle.MybatisObjectHandler;
...
@Configuration
@MapperScan({"com.kinzhan.dev.*.beans.mapper", "com.kinzhan.dev.*.beans.mapper.sys"})
