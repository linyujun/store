 ...
 */
package com.kinzhan.dev.platform.util.generator;
...
//        templateNames.add("QueryCriteriaP");
     ...
     * @return List
     */
    private static List<String> getFrontTemplateNames(SysGenConfig genConfig) {
        List<String> templateNames = new ArrayList<>();
        templateNames.add("index");
        if (null != genConfig.getPageType() && genConfig.getPageType().equals("dialog")) {
            templateNames.add("dialog");
        } else if (null != genConfig.getPageType() && genConfig.getPageType().equals("drawer")) {
            templateNames.add("dialog");
        } else {
    ...
    public static List<Map<String, Object>> preview(List<SysColumnConfig> columns, SysGenConfig genConfig) {
    ...
    public static String download(List<SysColumnConfig> columns, SysGenConfig genConfig) throws IOException {
        String tempPath =System.getProperty("java.io.tmpdir") + "temp" + File.separator + genConfig.getTableName() + File.separator;
        Map<String,Object> genMap = getGenMap(columns, genConfig);
        TemplateEngine engine = TemplateUtil.createEngine(new TemplateConfig("templates", TemplateConfig.ResourceMode.CLASSPATH));
        // 生成后端代码
        List<String> templates = getAdminTemplateNames();
    ...
    public static void generatorCode(List<SysColumnConfig> columnInfos, SysGenConfig genConfig) throws IOException {
        ...
        for (String templateName : templates) {
            Template template = engine.getTemplate("generator/front/"+templateName+".ftl");
            String apiPath = "src" + File.separator + "api" + File.separator;
            String srcPath = "src" + File.separator + "views" + File.separator + genMap.get("changeClassName").toString() + File.separator;
            String filePath = getFrontFilePath(templateName,apiPath,srcPath,genMap.get("changeClassName").toString());
            assert filePath != null;
            File file = new File(filePath);
    ...
    // 获取模版数据
    private static Map<String,Object> getGenMap(List<SysColumnConfig> columnInfos, SysGenConfig genConfig) {
        // 存储模版字段数据
        ...
        //页面打开模式
        genMap.put("pageType",genConfig.getPageType());
        //是否继承超类
        genMap.put("superClass",genConfig.getSuperClass());
        // 模块名称
        ...
        //全小写
        genMap.put("lowerCaseClassName", StringUtils.lowerCase(changeClassName));
        // 存在 Timestamp 字段
        ...
        for (SysColumnConfig column : columnInfos) {
            ...
            if("LocalDate".equals(colType) || "LocalDateTime".equals(colType)){
     ...
     * 定义后端文件路径以及名称
     */
    private static String getAdminFilePath(String templateName, SysGenConfig genConfig, String className, String rootPath) {
        String projectPath = rootPath + File.separator + genConfig.getModuleName();
        String packagePath = projectPath + File.separator + "src" +File.separator+ "main" + File.separator + "java" + File.separator;
        String miniClassName = StringUtils.toCamelCase(className);
        if (!ObjectUtils.isEmpty(genConfig.getPack())) {
            packagePath += genConfig.getPack().replace(".", File.separator) + File.separator;
        }
        if ("Entity".equals(templateName)) {
            return packagePath + "beans" + File.separator + "entity" + File.separator +  className + "Entity.java";
        }
        ...
        if ("Dto".equals(templateName)) {
            return packagePath + "beans" + File.separator + "dto" + File.separator + miniClassName + File.separator + className + "Dto.java";
        }
...
//            return packagePath + "beans" + File.separator + "dto" + File.separator + className + "QueryCriteria.java";
//        }
...
//        }
        ...
        if ("Mapper".equals(templateName)) {
            return packagePath + "beans" + File.separator + "mapper" + File.separator + className + "Mapper.java";
        }
        ...
        if ("Repository".equals(templateName)) {
            return packagePath + "beans" + File.separator + className + "Repository.java";
        }
    ...
    private static String getFrontFilePath(String templateName, String apiPath, String path, String apiName) {
        ...
        if ("dialog".equals(templateName)) {
            return path  + File.separator + "dialog.vue";
        }
