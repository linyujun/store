...
public class NotifyController {
    ...
    public Object receiveTicket(@RequestBody(required = false) String requestBody, @RequestParam("timestamp") String timestamp,
        ...
        log.info(
                "\n接收微信请求1：[signature=[{}], encType=[{}], msgSignature=[{}],"
        ...
        log.info("\n消息解密后内容为：\n{} ", inMessage.toString());
        if (inMessage.getInfoType().equals("component_verify_ticket")) {
            sysPropertyService.save("componentVerifyTicket", inMessage.getComponentVerifyTicket());
        }
        try {
    ...
    public Object callback(@RequestBody(required = false) String requestBody,
        ...
        log.info(
                "\n接收微信请求2：[appId=[{}], openid=[{}], signature=[{}], encType=[{}], msgSignature=[{}],"
                        + " timestamp=[{}], nonce=[{}], requestBody=[\n{}\n] ",
        ...
        if (StringUtils.equalsAnyIgnoreCase(appId, "wxd101a85aa106f53e", "wx570bc396a51b8ff8")) {
            ...
            WxMpXmlOutMessage outMessage = wxOpenMessageRouter.route(inMessage);
            if(outMessage != null){
